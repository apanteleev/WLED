...
def writePoints(file, data, name, length):
    file.write(f'static const int {name}[{length}][2] = {{\n')
...
with open(filename, 'w') as file:
    ...
    file.write('\n')
    writePoints(file, combinedStrip, 'g_WebbPositionsCartesian', 'WEBB_LEDS_COMBINED')
    file.write('\n')
    file.write('// Polar coordinates. Angle is from 0 to 16k.\n')
    writePoints(file, combinedStripPolar, 'g_WebbPositionsPolar', 'WEBB_LEDS_COMBINED')
